            ...
            <div class="px-4 py-2 -mx-3">
                <div class="mx-3">
                    <a href="{{ route('food.show') }}">
                        <span class="font-semibold text-blue-500">Agregar una comida</span>
                        <p class="text-sm text-gray-600">Añade una nueva comida a la lista.</p>
                </div>
                </a>
            </div>
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <div class="mt-4">
                                <a href="{{ route('food.viewEdit', $food->id) }}">
                                        <x-button class="block w-full">
                                            {{ __('Editar') }}
                                        </x-button>
                                </div>
